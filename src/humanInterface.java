...
//		}
    ...
    public int  run()
    {
        ...
        while((result = isEnded())==0) //game loop
        {
            ...
            {
                positionTicTacToe player2NextMove = ai2.myAIAlgorithm(board,2,2); //2 stands for player 2
    ...
    public static void main(String[] args) {
        ...
        //run game loop
//        humanInterface rttt = new humanInterface();
//        int x_pos = Integer.parseInt(args[0]);
//        int y_pos =Integer.parseInt(args[1]);
//        int z_pos = Integer.parseInt(args[2]);
//        System.out.println(x_pos + " " +y_pos + " " + z_pos);
//        userInput = new positionTicTacToe(x_pos,y_pos,z_pos);
        //rttt.run();
